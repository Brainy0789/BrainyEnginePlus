...
import core.animation.PsychAnimationController;
...
typedef CharacterFile = {
	...
	@:optional var iconIsAntialiased:Bool;
...
class Character extends FlxSprite
{
	...
	**/
	...
	public var iconIsAntialiased:Bool = true;
	...
	public function loadCharacterFile(json:Dynamic)
	{
		...
		iconIsAntialiased = (json.iconIsAntialiased != null) ? json.iconIsAntialiased : true;
	...
	@:allow(funkin.editors.character.states.CharacterEditorState)
