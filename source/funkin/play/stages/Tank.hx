...
class Tank extends BaseStage
{
	...
	override function create()
	{
		...
		if(!Preferences.data.lowQuality) foregroundSprites.add(new BGSprite('tank1', -300, 750, 2, 0.2, ['fg']));
		foregroundSprites.add(new BGSprite('tank2', 450, 940, 1.5, 1.5, ['foreground']));
		if(!Preferences.data.lowQuality) foregroundSprites.add(new BGSprite('tank4', 1300, 900, 1.5, 1.5, ['fg']));
		foregroundSprites.add(new BGSprite('tank5', 1620, 700, 1.5, 1.5, ['fg']));
		if(!Preferences.data.lowQuality) foregroundSprites.add(new BGSprite('tank3', 1300, 1200, 3.5, 2.5, ['fg']));
	...
	{
		if(!Preferences.data.lowQuality) tankWatchtower.dance();
	...
	function prepareCutscene()
	{
		...
		tankman.antialiasing = Preferences.data.antialiasing;
	...
	function stressIntro()
	{
		...
		pico.antialiasing = Preferences.data.antialiasing;
		...
		boyfriendCutscene.antialiasing = Preferences.data.antialiasing;
