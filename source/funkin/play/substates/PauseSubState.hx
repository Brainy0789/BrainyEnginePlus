...
class PauseSubState extends MusicBeatSubstate
{
	...
	function getPauseSong()
	{
		...
		var formattedPauseMusic:String = Paths.formatToSongPath(Preferences.data.pauseMusic);
		...
		if (controls.ACCEPT && (cantUnpause <= 0 || !controls.controllerMode))
		{
			...
			switch (daSelected)
			{
				...
				case 'Options':
					...
					{
						FlxG.sound.playMusic(Paths.music(Paths.formatToSongPath(Preferences.data.pauseMusic)), pauseMusic.volume);
